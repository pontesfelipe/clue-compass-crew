...
import { usePolicyAreas } from "@/hooks/useBills";
...
export default function VotesPage() {
  ...
  // Reuse the shared policy-areas hook instead of re-fetching every bill row:
  // the inline query here had no pagination and was silently capped at 1000 bills.
