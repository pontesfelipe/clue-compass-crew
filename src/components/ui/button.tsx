  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Neutral, calm primary action - charcoal with subtle hover
        hero: "bg-primary text-primary-foreground font-medium hover:bg-primary/90",
        civic: "bg-primary text-primary-foreground font-medium hover:bg-primary/90",
        "civic-outline": "border border-border text-foreground hover:bg-secondary",
        "civic-ghost": "text-muted-foreground hover:text-foreground hover:bg-secondary",
      },
      size: {
